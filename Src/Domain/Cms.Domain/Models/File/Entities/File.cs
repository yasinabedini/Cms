...
namespace Cms.Domain.Models.File.Entities
{
    public class File : AggregateRoot
    {
        ...
        public File(string name, long galleryId, string type, int length)
        {
            Name = name;
            GalleryId = galleryId;
            Type = type;
        ...
        public static File Create(string name, long galleryId, string type, int length)
        {
            return new File(name, galleryId, type, length);
        }
        #endregion
    }
}
