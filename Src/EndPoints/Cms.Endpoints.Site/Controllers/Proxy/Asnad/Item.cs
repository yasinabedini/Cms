namespace Cms.Endpoints.Site.Proxy.Asnad
{
    public class Item
    {
        ...
        public DateTime dateOfDocumentDescription { get; set; }
        ...
        public object mediaSourceId { get; set; }
        ...
        public object thematicCategories { get; set; }
        public object appendicesMedia { get; set; }
        public object mediaTypes { get; set; }
        public object meidaFields { get; set; }
