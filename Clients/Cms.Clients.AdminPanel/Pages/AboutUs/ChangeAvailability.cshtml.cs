...
namespace Cms.Clients.AdminPanel.Pages.AboutUs
{
    public class ChangeAvailabilityModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGet(int id)
        {
            ...
            #endregion
            About = JsonConvert.DeserializeObject<NewsViewModel>(modelResult);

            if (About.IsEnable)
            {
                About.IsEnable = false;
            }
            else
            {
                About.IsEnable = true;
            ...
            var updateModelData = new { Id = About.Id, Title = About.Title, Introduction = About.Introduction, LanguageId = About.LanguageId, NewsTypeId = About.NewsTypeId, IsEnable = About.IsEnable, Text = About.Text, MainImage = About.MainImageName, SecondImage = About.SecondImage, ThirdImage = About.ThirdImage };
